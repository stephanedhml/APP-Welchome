...
<header>
			...
			<nav id="menu">
				<ul>
						<div id="lienmenu">
							<li><a href="accueilmanu.php"><img src="logoonly.png" alt="logo" class="logo" /></a></li>
			...
			<!-- <table id="menu" >
				<tr>
					<td align="center""><a href="accueilmanu.html"><img src="logoonly.png" alt="logo" class="logo" /></a></td>
					<td align="center"><a href="#">Offres</a></td>
					<td align="center"><a href="#">Forum</a></td>
					<td align="center"><a href="#">Recherche avancée</a></td>
					<td align="center"><a href="#">Inscription</a></td>
					<td align="center"><a href="#">Connexion</a></td>
				</tr>
			</table> -->
		</header>
<?
...
?><br/>
<br/>
<a href="moteur_de_recherche.php">Faire une nouvelle recherche</a></p>
<?
...
<p>Nous n'avons trouvé aucun résultat pour votre requête "<? echo $_POST['requete']; ?>". <a href="moteur_de_recherche.php">Réessayez</a> avec autre chose.</p>
<?
}
