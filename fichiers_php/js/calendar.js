function valid() {
    //on teste que les champs ne soit pas vide
    if ((document.getElementById("date_deb").value != "" ) && (document.getElementById("date_fin").value)) {
        document.getElementById("url").innerHTML = '<a href="http://www.datebdd.fr/submittedfrom' + document.getElementById("date_deb").value + 'to' + document.getElementById("date_fin").value + '.csv">Télécharger</a>';
    } else {
        //sinon alert
...
var ds_element; // Text Element...<br>
var ds_monthnames = [<br>'janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin',<br>'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre'<br>]; // You can translate it for your language.<br>
var ds_daynames = [<br>'Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam'<br>]; // You can translate it for your language.
