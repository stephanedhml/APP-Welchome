...
<div class="menu_respo">
    <nav class="clearfix">
        ...
        <ul class="clearfix">
            ...
            <li class="recherche_avancee"><a href="recherche_avancee.php " class="cl"  onmouseover="affiche()"  ><?php echo rechercheavancee ?></a></li>
...
<div id='formrech'  class="formulaire_r_avancee1"  onmouseover="affiche()" onmouseout="cacher()" onsubmit="cacher()">
